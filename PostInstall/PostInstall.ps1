...
function download-resources {
    ...
    (New-Object System.Net.WebClient).DownloadFile("https://raw.githubusercontent.com/657870/Cloud-GPU-Updater/feature/windows10-support/GPUUpdaterTool.ps1", "$env:APPDATA\ParsecLoader\GPUUpdaterTool.ps1")
...
function Install7Zip {
    if ((gwmi win32_operatingsystem | % caption) -like '*Windows 10*') {
        ...
        (New-Object System.Net.WebClient).DownloadFile("https://www.7-zip.org/$($($($url.Links | Where-Object outerHTML -Like "*Download*")[1]).outerHTML.split('"')[1])" ,"C:\ParsecTemp\Apps\7zip.exe")
    } else {
...
function disable-devices {
    ...
    Start-Process -FilePath "C:\ParsecTemp\Devcon\devcon.exe" -ArgumentList '/r disable "VMBUS\{DA0A7802-E377-4AAC-8E77-*"'
    }
